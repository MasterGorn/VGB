...
const translations = {
  fr: {
    ...
    'role-unique-desc': 'Mouvement spécial du personnage (hors règles d\'échecs classiques).',
    ...
    'time-sand-desc': 'réduit le chrono adverse',
    ...
    'link': "Link",
    'link-desc': "Le héros légendaire d'Hyrule, porteur de l'Épée de Légende. Maître de l'épée et de la magie, il se déplace en ligne droite sur 3 cases maximum. Sa bravoure et sa sagesse en font un adversaire redoutable.",
    'mario': "Mario",
    'mario-desc': "Le plombier le plus célèbre du monde, héros de l'univers Nintendo. Se déplace en diagonale sur 2 cases avec une agilité et des capacités de saut exceptionnelles. Sa détermination et son courage en font un combattant redoutable.",
    'zelda': "Zelda",
    'zelda-desc': "Princesse d'Hyrule et gardienne de la Triforce de la Sagesse. Maîtresse des arts magiques, elle se déplace dans toutes les directions sur 8 cases avec une puissance magique immense. Sa sagesse et ses pouvoirs divins en font une adversaire redoutable.",
    'bowser': "Bowser",
    'bowser-desc': "Roi des Koopas et ennemi juré de Mario. Ce dragon-tortue géant se déplace dans toutes les directions sur 3 cases avec une force brute et une résistance exceptionnelles. Sa puissance destructrice et sa ténacité en font un adversaire redoutable.",
    'ganondorf': "Ganondorf",
    'ganondorf-desc': "Roi des Gerudos et incarnation du Mal, porteur de la Triforce du Pouvoir. Maître des arts sombres, il se déplace dans toutes les directions sur 4 cases avec des pouvoirs sombres et une magie noire redoutables. Sa soif de pouvoir et sa malveillance en font l'ennemi ultime.",
    'samus': "Samus",
    'samus-desc': "Chasseuse de prime galactique légendaire, protégée par une armure de combat avancée. Se déplace dans toutes les directions sur 4 cases avec une puissance de feu et une technologie de pointe. Sa détermination et ses capacités de combat en font une adversaire redoutable.",
    'pit': "Pit",
    'pit-desc': "Ange gardien de Palutena, commandant de l'armée céleste. Se déplace dans toutes les directions sur 3 cases avec des capacités de vol et des attaques à distance avec son arc divin. Sa loyauté et sa bravoure en font un combattant redoutable.",
    'palutena': "Palutena",
    'palutena-desc': "Déesse de la Lumière et protectrice d'Angel Land, souveraine des cieux. Se déplace dans toutes les directions sur 6 cases avec des pouvoirs divins et une magie sacrée incomparable. Sa sagesse divine et sa puissance en font une adversaire redoutable.",
    'sheik': "Sheik",
    'sheik-desc': "Identité secrète de Zelda, maître des arts ninja. Se déplace en diagonale et en L sur 2 cases avec une agilité et des techniques ninja redoutables. Sa discrétion et sa rapidité en font un adversaire redoutable.",
    'wario': "Wario",
    'wario-desc': "Cousin avare et malveillant de Mario, entrepreneur cupide. Se déplace dans toutes les directions sur 2 cases avec une force brute et une résistance aux dégâts exceptionnelles. Sa cupidité et sa ténacité en font un adversaire redoutable.",
    'duo-duck-hunt': "Duo Duck Hunt",
    'duo-duck-hunt-desc': "Chasseur et son canard fidèle. Se déplace en ligne droite sur 5 cases. Attaques à distance et travail d'équipe.",
    'wii-fit-trainer': "Wii Fit Trainer",
    'wii-fit-trainer-desc': "Instructeur de fitness Wii. Se déplace dans toutes les directions sur 2 cases. Équilibre et techniques de yoga.",
    'luigi': "Luigi",
    'luigi-desc': "Frère loyal de Mario, héros en vert. Se déplace dans toutes les directions sur 2 cases avec une agilité et des capacités de saut exceptionnelles. Sa loyauté et son courage timide mais déterminé en font un allié précieux.",
    'peach': "Peach",
    'peach-desc': "Princesse du Royaume Champignon, souveraine bienveillante. Se déplace dans toutes les directions sur 3 cases avec grâce et pouvoirs magiques. Sa gentillesse et sa détermination cachent une force redoutable.",
    'kirby': "Kirby",
    'kirby-desc': "Étoile rose gourmande de la planète Pop Star. Se déplace en ligne droite sur 3 cases avec des capacités d'absorption et de copie d'aptitudes uniques. Sa nature joyeuse cache un pouvoir redoutable.",
    ...
    'daisy': "Daisy",
    'daisy-desc': "Princesse de Sarasaland. Héroïne vive et déterminée du Royaume Champignon.",
    'lucina': "Lucina",
    'lucina-desc': "Princesse du futur d'Ylisse. Combattante légendaire aux pouvoirs du Brand.",
    'lyn': "Lyn",
    'lyn-desc': "Épéiste des plaines de Sacae. Grâce et précision redoutables.",
    'pyra-mythra': "Pyra & Mythra",
    'pyra-mythra-desc': "Blades Aegis. Duo de puissance et de lumière au cœur de l'aventure.",
    'marie': "Marie",
    'marie-desc': "Idol Squid Sisters. Stratège charismatique de l'encre et du style.",
    'min-min': "Min Min",
    'min-min-desc': "Championne ARMS du ramen. Bras extensibles et technique affûtée.",
    'samus-sans-armure': "Samus sans armure",
    'samus-sans-armure-desc': "Samus Aran en combinaison Zero Suit. Agilité et précision hors armure.",
    'perle-et-coralie': "Perle et Coralie",
    'perle-et-coralie-desc': "Duo Off the Hook. Stars de la musique et de la révolution de l'encre.",
    'krystal': "Krystal",
    'krystal-desc': "Télépathe de Cerinia. Pilote et guerrière aux sens aiguisés.",
    'fox-mccloud': "Fox McCloud",
    'fox-mccloud-desc': "Leader de l'équipe Star Fox. Pilote d'élite et combattant agile.",
    'falco-lombardi': "Falco Lombardi",
    'falco-lombardi-desc': "As de l'équipe Star Fox. Vitesse, attitude et précision de tir.",
    'wolf-o-donnell': "Wolf O'Donnell",
    'wolf-o-donnell-desc': "Rival de Fox. Mercenaire redoutable de Star Wolf.",
    'marth': "Marth",
    'marth-desc': "Prince d'Altea. Héros de l'épée et symbole de Fire Emblem.",
    'roy': "Roy",
    'roy-desc': "Jeune seigneur de Pherae. Épée enflammée et leadership.",
    'yoshi': "Yoshi",
    'yoshi-desc': "Dinosaure fidèle. Sauts, langue extensible et mobilité acrobatique.",
    'little-mac': "Little Mac",
    'little-mac-desc': "Boxeur de Brooklyn. Esquives et crochets décisifs.",
    'dixie-kong': "Dixie Kong",
    'dixie-kong-desc': "Aventurière de la jungle. Queue propulsive et agilité.",
    'ribbon-girl': "Ribbon Girl",
    'ribbon-girl-desc': "Idol ARMS. Combats aériens et rythme effréné.",
    'springman': "Spring Man",
    'springman-desc': "Combattant à ressorts. Énergie et punchs extensibles.",
    'rex': "Rex",
    'rex-desc': "Pilote de Blade. Courage et bondissements au cœur du combat.",
    'james-mccloud': "James McCloud",
    'james-mccloud-desc': "Légende de Star Fox. Père de Fox et as du cockpit.",
    'ice-climbers': "Ice Climbers",
    'ice-climbers-desc': "Duo Popo & Nana. Escalade, maillets et coordination.",
    'ike': "Ike",
    'ike-desc': "Mercenaire de Tellius. Force brute et Ragnell légendaire.",
    'roi-dadidou': "Roi Dadidou",
    'roi-dadidou-desc': "Roi de Dream Land. Marteau colossal et présence imposante.",
    'ridley': "Ridley",
    'ridley-desc': "Dragon Spatial des Pirates. Terreur aérienne de la série Metroid.",
    'general-pepper': "General Pepper",
    'general-pepper-desc': "Commandant de Corneria. Autorité militaire et stratégie spatiale.",
    'ness': "Ness",
    'ness-desc': "Enfant psychique d'Onett. PSI et courage hors norme.",
    'lucas': "Lucas",
    'lucas-desc': "Enfant de Tazmily. Pouvoirs psychiques et détermination.",
    'captain-olimar': "Captain Olimar",
    'captain-olimar-desc': "Explorateur Hocotate. Stratégie, Pikmin et survie.",
    'tom-nook': "Tom Nook",
    'tom-nook-desc': "Commerçant de l'île. Negociateur rusé et bâtisseur.",
    'mewtwo': "Mewtwo",
    'mewtwo-desc': "Pokémon légendaire créé par l'homme. Pouvoirs psychiques dévastateurs.",
    'mr-game-and-watch': "Mr. Game & Watch",
    'mr-game-and-watch-desc': "Icône LCD. Transformations 2D et coups imprévisibles.",
    'toad': "Toad",
    'toad-desc': "Fidèle sujet du Royaume Champignon. Courageux messager et allié de Mario.",
    'bowser-junior': "Bowser Junior",
    'bowser-junior-desc': "Héritier des Koopas. Farceur, pinceau magique et ambition royale.",
    'villageois': "Villageois",
    'villageois-desc': "Habitant de l'île. Outils du quotidien devenus armes improvisées.",
    'rondoudou': "Rondoudou",
    'rondoudou-desc': "Pokémon Ballon. Berceuse et souffle explosif.",
    'peppy-hare': "Peppy Hare",
    'peppy-hare-desc': "Vétéran de Star Fox. Conseil avisé et soutien loyal.",
    'slippy-toad': "Slippy Toad",
    'slippy-toad-desc': "Ingénieur de Star Fox. Gadgets et soutien technique.",
    'helix': "Helix",
    'helix-desc': "Créature ARMS. Corps élastique et attaques surprises.",
    'hero-ring-fit-adventure': "Héros Ring Fit",
    'hero-ring-fit-adventure-desc': "Aventurier fitness. Endurance et combats sportifs.",
    'fille-inkling': "Fille Inkling",
    'fille-inkling-desc': "Guerrière de l'encre. Tir, natation et style urbain.",
    'vlad': "Vlad",
    'vlad-desc': "Combattant ARMS. Présence imposante et bras mécaniques.",
    ...
    'clarissa': "Clarissa",
    'clarissa-desc': "Pilote d'OutRun 2. Compagne de route, élégance et vitesse sur l'asphalte.",
    'tyris-flare': "Tyris Flare",
    'tyris-flare-desc': "Guerrière amazone. Magie du feu et lame flamboyante.",
    'gena': "Gena",
    'gena-desc': "Roller-girl de Tokyo-to. Graffiti, style et liberté.",
    'billy-hatcher': "Billy Hatcher",
    'billy-hatcher-desc': "Héros au chapeau d'œuf. Sauts, roulades et courage.",
    'ax-battler': "Ax Battler",
    'ax-battler-desc': "Barbare de Golden Axe. Hache lourde et charges frontales.",
    'bd-joe': "B.D. Joe",
    'bd-joe-desc': "Chauffeur de Crazy Taxi. Vitesse urbaine et cascades.",
    'mec-space-harrier': "Mec Space Harrier",
    'mec-space-harrier-desc': "Pilote de Space Harrier. Vol acrobatique et tirs laser.",
    'taro-sega-boy': "Taro Sega Boy",
    'taro-sega-boy-desc': "Mascotte SEGA. Énergie et esprit d'aventure.",
    'taro-sega-girl': "Taro Sega Girl",
    'taro-sega-girl-desc': "Mascotte SEGA. Élan, style et fair-play.",
    'death-adder': "Death Adder",
    'death-adder-desc': "Seigneur de guerre. Force brute et présence menaçante.",
    'gilius-thunderhead': "Gilius Thunderhead",
    'gilius-thunderhead-desc': "Nain guerrier. Hache et foudre destructrices.",
    'aiai': "AiAi",
    'aiai-desc': "Singe acrobatique. Équilibre, sphères et trajectoires folles.",
    'puyo-puyo': "Puyo Puyo",
    'puyo-puyo-desc': "Créature puzzle. Combinaisons colorées et chaos joyeux.",
    'alberto': "Alberto",
    'alberto-desc': "Personnage SEGA. Technique et déplacements rusés.",
    'gus': "Gus",
    'gus-desc': "Allié SEGA. Soutien loyal sur le terrain.",
    'mew-mew': "Mew Mew",
    'mew-mew-desc': "Créature adorable. Mobilité légère et surprises.",
    'axel': "Axel",
    'axel-desc': "Combattant des rues. Coups droits et détermination.",
  ...
  en: {
    ...
    'time-sand': 'Time Sand',
    'time-sand-desc': 'reduces the opponent\'s clock',
    ...
    'ayo-oli-desc': "Agents d'élite. Se déplace dans toutes les directions sur 3 cases. Encre et combat urbain.",
    'daisy': "Daisy",
    'daisy-desc': "Princess of Sarasaland. Spirited heroine of the Mushroom Kingdom.",
    'lucina': "Lucina",
    'lucina-desc': "Princess from Ylisse's future. Legendary fighter bearing the Brand.",
    'lyn': "Lyn",
    'lyn-desc': "Swordswoman of the Sacae plains. Graceful and deadly precision.",
    'pyra-mythra': "Pyra & Mythra",
    'pyra-mythra-desc': "Aegis Blades. A duo of power and light at the heart of the adventure.",
    'marie': "Callie",
    'marie-desc': "Squid Sisters idol. Charismatic ink strategist with style.",
    'min-min': "Min Min",
    'min-min-desc': "ARMS ramen champion. Stretchy arms and sharp technique.",
    'samus-sans-armure': "Zero Suit Samus",
    'samus-sans-armure-desc': "Samus Aran in Zero Suit. Agility and precision without the armor.",
    'perle-et-coralie': "Pearl & Marina",
    'perle-et-coralie-desc': "Off the Hook duo. Music stars and ink revolutionaries.",
    'krystal': "Krystal",
    'krystal-desc': "Cerinian telepath. Pilot and warrior with keen senses.",
    'fox-mccloud': "Fox McCloud",
    'fox-mccloud-desc': "Star Fox team leader. Elite pilot and agile fighter.",
    'falco-lombardi': "Falco Lombardi",
    'falco-lombardi-desc': "Star Fox ace. Speed, attitude and pinpoint shooting.",
    'wolf-o-donnell': "Wolf O'Donnell",
    'wolf-o-donnell-desc': "Fox's rival. Ruthless Star Wolf mercenary.",
    'marth': "Marth",
    'marth-desc': "Prince of Altea. Sword hero and Fire Emblem icon.",
    'roy': "Roy",
    'roy-desc': "Young lord of Pherae. Flaming blade and leadership.",
    'yoshi': "Yoshi",
    'yoshi-desc': "Loyal dinosaur. Jumps, long tongue and acrobatic mobility.",
    'little-mac': "Little Mac",
    'little-mac-desc': "Brooklyn boxer. Dodges and decisive hooks.",
    'dixie-kong': "Dixie Kong",
    'dixie-kong-desc': "Jungle adventurer. Propeller ponytail and agility.",
    'ribbon-girl': "Ribbon Girl",
    'ribbon-girl-desc': "ARMS idol. Aerial fights and frantic rhythm.",
    'springman': "Spring Man",
    'springman-desc': "Spring-powered fighter. Energy and stretchy punches.",
    'rex': "Rex",
    'rex-desc': "Blade driver. Courage and leaps in the heat of battle.",
    'james-mccloud': "James McCloud",
    'james-mccloud-desc': "Star Fox legend. Fox's father and cockpit ace.",
    'ice-climbers': "Ice Climbers",
    'ice-climbers-desc': "Popo & Nana duo. Climbing, mallets and teamwork.",
    'ike': "Ike",
    'ike-desc': "Tellius mercenary. Raw power and legendary Ragnell.",
    'roi-dadidou': "King Dedede",
    'roi-dadidou-desc': "King of Dream Land. Colossal hammer and imposing presence.",
    'ridley': "Ridley",
    'ridley-desc': "Space Pirate dragon. Aerial terror of the Metroid series.",
    'general-pepper': "General Pepper",
    'general-pepper-desc': "Corneria commander. Military authority and space strategy.",
    'ness': "Ness",
    'ness-desc': "Psychic kid from Onett. PSI powers and uncommon courage.",
    'lucas': "Lucas",
    'lucas-desc': "Child of Tazmily. Psychic powers and determination.",
    'captain-olimar': "Captain Olimar",
    'captain-olimar-desc': "Hocotate explorer. Strategy, Pikmin and survival.",
    'tom-nook': "Tom Nook",
    'tom-nook-desc': "Island shopkeeper. Shrewd negotiator and builder.",
    'mewtwo': "Mewtwo",
    'mewtwo-desc': "Man-made legendary Pokémon. Devastating psychic powers.",
    'mr-game-and-watch': "Mr. Game & Watch",
    'mr-game-and-watch-desc': "LCD icon. 2D transformations and unpredictable moves.",
    'toad': "Toad",
    'toad-desc': "Loyal Mushroom Kingdom subject. Brave messenger and Mario's ally.",
    'bowser-junior': "Bowser Jr.",
    'bowser-junior-desc': "Koopa heir. Prankster with a magic brush and royal ambition.",
    'villageois': "Villager",
    'villageois-desc': "Island resident. Everyday tools turned improvised weapons.",
    'rondoudou': "Jigglypuff",
    'rondoudou-desc': "Balloon Pokémon. Lullaby and explosive puff.",
    'peppy-hare': "Peppy Hare",
    'peppy-hare-desc': "Star Fox veteran. Wise advice and loyal support.",
    'slippy-toad': "Slippy Toad",
    'slippy-toad-desc': "Star Fox engineer. Gadgets and technical support.",
    'helix': "Helix",
    'helix-desc': "ARMS creature. Elastic body and surprise attacks.",
    'hero-ring-fit-adventure': "Ring Fit Hero",
    'hero-ring-fit-adventure-desc': "Fitness adventurer. Endurance and sporty combat.",
    'fille-inkling': "Inkling Girl",
    'fille-inkling-desc': "Ink warrior. Shooting, swimming and urban style.",
    'vlad': "Vlad",
    'vlad-desc': "ARMS fighter. Imposing presence and mechanical arms.",
    'the-legend-of-zelda': "The Legend of Zelda",
    'super-mario': "Super Mario",
    'metroid': "Metroid",
    'kid-icarus': "Kid Icarus",
    ...
    'clarissa': "Clarissa",
    'clarissa-desc': "OutRun 2 co-driver. Road companion with elegance and asphalt speed.",
    'tyris-flare': "Tyris Flare",
    'tyris-flare-desc': "Amazon warrior. Fire magic and a flaming blade.",
    'gena': "Gena",
    'gena-desc': "Tokyo-to roller girl. Graffiti, style and freedom.",
    'billy-hatcher': "Billy Hatcher",
    'billy-hatcher-desc': "Hero with an egg hat. Jumps, rolls and courage.",
    'ax-battler': "Ax Battler",
    'ax-battler-desc': "Golden Axe barbarian. Heavy axe and frontal charges.",
    'bd-joe': "B.D. Joe",
    'bd-joe-desc': "Crazy Taxi driver. Urban speed and stunts.",
    'mec-space-harrier': "Space Harrier Pilot",
    'mec-space-harrier-desc': "Space Harrier pilot. Acrobat flight and laser fire.",
    'taro-sega-boy': "Taro Sega Boy",
    'taro-sega-boy-desc': "SEGA mascot. Energy and adventure spirit.",
    'taro-sega-girl': "Taro Sega Girl",
    'taro-sega-girl-desc': "SEGA mascot. Drive, style and fair play.",
    'death-adder': "Death Adder",
    'death-adder-desc': "Warlord. Raw power and menacing presence.",
    'gilius-thunderhead': "Gilius Thunderhead",
    'gilius-thunderhead-desc': "Dwarf warrior. Axe and destructive lightning.",
    'aiai': "AiAi",
    'aiai-desc': "Acrobatic monkey. Balance, spheres and wild trajectories.",
    'puyo-puyo': "Puyo Puyo",
    'puyo-puyo-desc': "Puzzle creature. Colorful combos and joyful chaos.",
    'alberto': "Alberto",
    'alberto-desc': "SEGA character. Technique and crafty movement.",
    'gus': "Gus",
    'gus-desc': "SEGA ally. Loyal support on the field.",
    'mew-mew': "Mew Mew",
    'mew-mew-desc': "Adorable creature. Light mobility and surprises.",
    'axel': "Axel",
    'axel-desc': "Street fighter. Straight punches and determination.",
    'skies-of-arcadia': "Skies of Arcadia",
    'golden-axe': "Golden Axe",
    'jet-set-radio': "Jet Set Radio",
    'billy-hatcher': "Billy Hatcher",
