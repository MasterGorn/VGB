...
const translations = {
  fr: {
    ...
    'cg-blurb-short': 'Une initiative de <a class="cg-logo-link" href="https://www.culture-games.com" target="_blank" rel="noopener noreferrer"><img class="cg-logo" src="/images/site/logo-header-culture-games-v5.svg" alt="Culture Games" /></a> pour faire connaître les mascottes du jeu vidéo — et apprendre en s’amusant.',
    'cg-blurb-more': 'La liste des pièces propose des liens vers des fiches pour approfondir vos connaissances sur chaque personnage. Un mini-jeu pensé pour promouvoir la culture vidéoludique tout en s’amusant.',
    'cg-see-more': 'Voir plus',
    'cg-see-less': 'Voir moins',
    ...
    'king-playstation': 'Président Sony',
    'king-sega': 'Roi SEGA',
    'king-xbox': 'Roi Xbox',
    ...
    'star-desc': 'Invincibilité ! Rend vos pièces invincibles jusqu\'à votre prochain tour.',
    ...
    'star': 'Étoile',
    'star-desc': 'Rend vos pièces invincibles jusqu\'à votre prochain tour',
    ...
    'about-creator-nav': 'Le créateur',
    'about-creator-title': 'Qui suis-je ?',
    'about-creator-p1': 'Fan de jeux vidéo depuis le début des années 90, je suis passionné et actif dans la communauté Super Smash Bros., et créateur des sites ssb-experience.com et culture-games.com.',
    'about-creator-p2': 'Amateur d’échecs aussi, avec de bons souvenirs du jeu de société Tempête sur l’échiquier.',
    'about-creator-p3': 'Video Games Battle réunit tous ces centres d’intérêt : un jeu fait par un fan, pour les fans.',
    ...
    'objection-name': 'Objection',
    'sonic-shoes-name': 'Chaussures de Sonic',
    'turret-name': 'Tourelle',
    'paint-bomb-name': 'Bombe de peinture',
    'pokeball-name': 'Pokéball',
    'cardboard-name': 'Carton',
    'proximity-mine-name': 'Mine de proximité',
    'fake-crate-name': 'Fausse caisse',
    'cherry-name': 'Cerise',
    'storm-wall-name': 'Mur de la Tempête',
    'golden-gun-name': 'Golden Gun',
    'crowbar-name': 'Pied de biche',
    'mana-potion-name': 'Potion de mana',
    ...
    'star-desc': 'Invincibilité ! Rend <strong>vos pièces invincibles</strong> jusqu\'à votre prochain tour.',
    'star-details': 'Vos pièces deviennent invincibles jusqu\'à votre prochain tour : aucune capture ni destruction d\'objet ne peut les toucher. Inspiré de Super Mario Bros.',
    ...
    'phoenix-no-piece': 'Aucune pièce perdue à ressusciter.',
    ...
    'objection-desc': 'Ace Attorney ! <strong>Annule le coup précédent</strong> et l’interdit le tour suivant.',
    'objection-details': 'Annule le dernier déplacement (et une éventuelle capture simple). L’adversaire ne peut pas rejouer exactement ce coup lors de son tour suivant. Consomme votre tour. Inspiré de Ace Attorney.',
    'sonic-shoes-desc': 'Vitesse Sonic ! Permet à un <strong>pion, cavalier ou fou</strong> de jouer <strong>deux coups</strong> dans le même tour.',
    'sonic-shoes-details': 'Activez les chaussures, puis déplacez deux fois la même pièce (pion, cavalier ou fou uniquement). Inspiré de Sonic the Hedgehog.',
    'turret-desc': 'Worms ! Choisissez une <strong>colonne</strong> : toute pièce adverse qui s’y pose est détruite. La tourelle disparaît après une capture.',
    'turret-details': 'La colonne entière est marquée (des deux côtés du plateau). Toute pièce adverse qui se pose sur une de ces cases disparaît, peu importe d’où elle vient — y compris un pion qui avance déjà dans la colonne. Les pièces adverses peuvent sortir de la colonne sans être touchées tant qu’elles ne se reposent pas dessus. Inspiré de Worms.',
    'paint-bomb-desc': 'Jet Set Radio ! Peint <strong>9 cases</strong> (la case choisie et les 8 adjacentes) pendant <strong>5 tours</strong> : on n’y voit plus rien, mais le jeu continue normalement.',
    'paint-bomb-details': 'Les pièces sous peinture restent jouables mais deviennent invisibles sous l’effet. La peinture disparaît après 5 tours. Inspiré de Jet Set Radio.',
    'pokeball-desc': 'Pokémon ! Invoque un <strong>Pokémon au hasard</strong> (Pikachu ou Rondoudou pour l’instant) près de votre roi, avec son déplacement habituel.',
    'pokeball-details': 'Le Pokémon apparaît sur une case libre proche de votre roi. D’autres espèces pourront être ajoutées au fil du temps. Inspiré de Pokémon.',
    'cardboard-desc': 'Metal Gear ! <strong>Camoufle une pièce pendant 5 tours</strong> : seul vous la voyez, elle devient invisible pour l’adversaire.',
    'cardboard-details': 'Choisissez n’importe quelle pièce (alliée ou ennemie). Pendant 5 tours, vous la voyez normalement ; l’adversaire ne la voit plus sur le plateau. Inspiré de Metal Gear Solid.',
    'proximity-mine-desc': 'Perfect Dark ! Pose une <strong>mine invisible</strong> pour l’adversaire : la première pièce (alliée ou ennemie) qui marche dessus explose.',
    'proximity-mine-details': 'Placez la mine sur une case vide. Seul le joueur qui l’a posée la voit. Elle reste active jusqu’à explosion ou fin de partie. Inspiré de Perfect Dark.',
    
    'fake-crate-desc': 'Mario Kart ! Une <strong>fausse caisse</strong> remplace parfois une vraie caisse (1 chance sur 20). Le joueur qui marche dessus perd sa pièce.',
    'fake-crate-details': 'Ressemble beaucoup à une vraie caisse. La pièce qui marche dessus est détruite, puis la fausse caisse est remplacée par une vraie. Inspiré de Mario Kart.',
    'cherry-desc': 'Pac-Man ! La cerise <strong>double le prochain objet</strong> obtenu : vous recevez deux exemplaires au lieu d\'un.',
    'cherry-details': 'Utilisez la cerise et le prochain objet trouvé dans une caisse sera doublé (si vous avez la place dans votre inventaire). Inspiré de Pac-Man.',
    'storm-wall-desc': 'Fortnite ! Active le <strong>Mur de la Tempête</strong> : le plateau rétrécit d\'une case par côté par tour. Les pièces hors zone sont perdues.',
    'storm-wall-details': 'Utilisable après 10 tours. Le plateau diminue progressivement : toute pièce restant dans la zone de tempête est détruite. Inspiré de Fortnite.',
    'golden-gun-desc': 'GoldenEye 007 ! Tire sur <strong>n\'importe quelle pièce</strong> et l\'élimine instantanément, même le roi. Extrêmement rare.',
    'golden-gun-details': 'Cliquez sur n\'importe quelle pièce du plateau pour la détruire. Aucune protection (étoile, cœur) ne résiste au Golden Gun. L\'objet le plus rare du jeu. Inspiré de GoldenEye 007.',
    'crowbar-desc': 'Half-Life ! Détruit <strong>n\'importe quel objet</strong> posé sur le plateau : banane, tétrimino, tache de peinture, mine, tourelle…',
    'crowbar-details': 'Cliquez sur une case contenant un obstacle ou un piège pour le détruire. Ne détruit pas les pièces ni les caisses. Inspiré de Half-Life.',
    'mana-potion-desc': 'Diablo II ! La <strong>potion de mana</strong> réinitialise les délais d’attente : éclair et capacités à recharge redeviennent utilisables immédiatement.',
    'mana-potion-details': 'Cliquez pour boire la potion. Tous les objets en cooldown dans votre inventaire (comme la Foudre) et les capacités Unique en recharge sont remis à zéro. Ne consomme pas votre action d’objet : vous pouvez enchaîner avec l’éclair le même tour. Inspiré de Diablo II.',
    ...
    'deacon-st-john-desc': "Biker survivant de Days Gone. Motos, Freakers et quête de Sarah. L’Oregon post-apocalyptique a un visage.",
    'deacon-st-john': "Deacon St John",
    'chloe-frazer-desc': "Chasseuse de trésors d’Uncharted. Accent australien, ambition et alliée parfois rivale de Nate. Elle mène sa propre aventure.",
    'chloe-frazer': "Chloe Frazer",
    'carmelita-fox-desc': "Inspectrice Interpol dans Sly Cooper. Shock pistol, justice et… attirance pour le voleur. L’ordre a du panache.",
    'carmelita-fox': "Carmelita Fox",
    'trico-desc': "Créature ailée de The Last Guardian. Lien silencieux avec le garçon, bondissements et éclairs. La confiance se gagne plume à plume.",
    'trico': "Trico",
    'abby-desc': "Guerrière de The Last of Us Part II. Force brute, vengeance et rédemption ambiguë. Deux faces d’une même guerre.",
    'abby': "Abby",
    'joel-desc': "Contrebandier de The Last of Us. Père perdu, Ellie trouvée, choix impossibles. La survie a un coût.",
    'joel': "Joel",
    'jin-sakai-desc': "Samouraï devenu Fantôme dans Ghost of Tsushima. Honneur brisé, Mongols chassés, île défendue. La voie du bushido… ou de l’ombre.",
    'jin-sakai': "Jin Sakai",
    'kratos': "Kratos",
    'toro-inoue-desc': "Chat blanc mascotte de Doko Demo Issyo / PlayStation. Doux, curieux, ambassadeur japonais de Sony. « Torō desu. »",
    'toro-inoue': "Toro Inoue",
    'sly-cooper-desc': "Raton laveur voleur gentilhomme de Sly Cooper. Canne, stealth et héritage familial. Les coffres n’ont qu’à bien se tenir.",
    'sly-cooper': "Sly Cooper",
    'sir-daniel-fortesque-desc': "Chevalier squelette de MediEvil. Héros malgré lui, mâchoire lâchée et humour macabre. Gallowmere a besoin de lui… encore.",
    'sir-daniel-fortesque': "Sir Daniel Fortesque",
    'ratchet-desc': "Lombax inventeur de Ratchet & Clank. Armes ridicules, galaxies à sauver, Clank sur le dos. Le héros à fourrure orange.",
    'ratchet': "Ratchet",
    'cole-macgrath-desc': "Coursier devenu conduit électrique dans inFAMOUS. Karma, éclairs et Empire City. Le pouvoir choisit son camp.",
    'cole-macgrath': "Cole MacGrath",
    'william-adams-desc': "Samouraï occidental de Nioh. Yokai, ki et lames multiples. L’Angleterre rencontre le Japon féodal.",
    'william-adams': "William Adams",
    'pilote-gran-turismo-desc': "Pilote anonyme de Gran Turismo. Virages parfaits, télémétrie et passion automobile. Le real driving simulator en personne.",
    'pilote-gran-turismo': "Pilote Gran Turismo",
    'ellie-desc': "Héroïne de The Last of Us. Immunisée, déterminée, brisée et indomptable. La survie a le visage d’une ado.",
    'ellie': "Ellie",
    'atreus-desc': "Fils de Kratos dans God of War. Archer, langues anciennes et destin divin. « Boy » devient un héros.",
    'atreus': "Atreus",
    'nathan-drake': "Nathan Drake",
    'clank-desc': "Robot Zoni et conscience de Ratchet & Clank. Petit, brillant, souvent porté… mais indispensable. La voix de la raison (et des gadgets).",
    'clank': "Clank",
    'jak': 'Jak',
    ...
    'ecco-dolphin-desc': "Dauphin d'Ecco the Dolphin, sauveur des océans temporels. Sonar, mystère et voyage à travers les ères. La mer chante avec lui. Nage libre : se déplace comme une tour et peut traverser une pièce pour capturer la suivante sur la même ligne ou colonne.",
    ...
    'viva-pinata-desc': "Créature piñata de Viva Piñata, jardin et élevage colorés. Attirez, soignez, fêtez — sans trop secouer. Le jardin est un écosystème joyeux. Éclatement de confettis : une fois capturée, donne 3 objets aléatoires et différents au joueur auquel elle appartenait.",
    ...
    'cooper': 'Cooper',
    'cooper-desc': "Héros de Grabbed by the Ghoulies, jeu Rareware sorti sur Xbox. Dans le manoir hanté des Ghoulies, humour british et baston arcade. Un classique Rare trop souvent oublié.",
    'hornet': 'Hornet',
    ...
    'moine': 'Moine',
    'moine-desc': "Moine d'Age of Empires, unité culte capable de convertir l'ennemi au cri de « Wololo ! ». Foi, patience et un brin de magie : il retourne les troupes sans lever l'épée. Conversion : 100 % sur un pion, 75 % sur un cavalier, 50 % sur une tour, 25 % sur une dame ; 0 % sur une pièce unique ou un roi.",
    'vela': 'Vela',
    ...
    'moine-ability': "Conversion (Wololo) : 100 % pion, 75 % cavalier, 50 % tour, 25 % dame ; 0 % unique ou roi.",
    ...
    'viva-pinata-ability': "Éclatement de confettis : une fois capturée, donne 3 objets aléatoires et différents au joueur auquel elle appartenait.",
    'ecco-dolphin-ability': "Nage libre : se déplace comme une tour et peut traverser une pièce pour capturer la suivante sur la même ligne ou colonne.",
  ...
  en: {
    ...
    'cg-blurb-short': 'An initiative by <a class="cg-logo-link" href="https://www.culture-games.com" target="_blank" rel="noopener noreferrer"><img class="cg-logo" src="/images/site/logo-header-culture-games-v5.svg" alt="Culture Games" /></a> to showcase video game mascots — and learn while having fun.',
    'cg-blurb-more': 'The piece list links to character sheets so you can dig deeper into each mascot. A mini-game designed to promote video game culture while having fun.',
    'cg-see-more': 'See more',
    'cg-see-less': 'See less',
    ...
    'king-playstation': 'Sony President',
    'king-sega': 'SEGA King',
    'king-xbox': 'Xbox King',
    ...
    'star-desc': 'Invincibility! Makes your pieces invincible until your next turn.',
    ...
    'star': 'Star',
    'star-desc': 'Makes your pieces invincible until your next turn',
    ...
    'about-creator-nav': 'The creator',
    'about-creator-title': 'Who am I?',
    'about-creator-p1': 'A video game fan since the early 90s, active in the Super Smash Bros. community, and creator of ssb-experience.com and culture-games.com.',
    'about-creator-p2': 'Also an amateur chess player, with fond memories of the board game Tempest on the Chessboard (Tempête sur l’échiquier).',
    'about-creator-p3': 'Video Games Battle brings all these passions together: a game made by a fan, for fans.',
    'owner-of': 'Owner of:',
    ...
    'objection-name': 'Objection',
    'sonic-shoes-name': 'Sonic\'s Shoes',
    'turret-name': 'Turret',
    'paint-bomb-name': 'Paint Bomb',
    'pokeball-name': 'Poké Ball',
    'cardboard-name': 'Cardboard Box',
    'proximity-mine-name': 'Proximity Mine',
    'fake-crate-name': 'Fake Crate',
    'cherry-name': 'Cherry',
    'storm-wall-name': 'Storm Wall',
    'golden-gun-name': 'Golden Gun',
    'crowbar-name': 'Crowbar',
    'mana-potion-name': 'Mana Potion',
    ...
    'star-desc': 'Invincibility! Makes <strong>your pieces invincible</strong> until your next turn.',
    'star-details': 'Your pieces become invincible until your next turn: no capture or item destruction can affect them. Inspired by Super Mario Bros.',
    ...
    'phoenix-no-piece': 'No lost piece to revive.',
    ...
    'objection-desc': 'Ace Attorney! <strong>Cancels the previous move</strong> and forbids replaying it next turn.',
    'objection-details': 'Undoes the last piece move (and a simple capture if any). The opponent cannot replay that exact move on their next turn. Consumes your turn. Inspired by Ace Attorney.',
    'sonic-shoes-desc': 'Sonic speed! Lets a <strong>pawn, knight or bishop</strong> play <strong>two moves</strong> in the same turn.',
    'sonic-shoes-details': 'Activate the shoes, then move the same piece twice (pawn, knight or bishop only). Inspired by Sonic the Hedgehog.',
    'turret-desc': 'Worms! Choose a <strong>column</strong>: any enemy piece that lands on it is destroyed. The turret disappears after one capture.',
    'turret-details': 'The entire column is marked. Any enemy piece that lands on one of those squares is destroyed, no matter where it came from — including a pawn already moving inside the column. Enemy pieces may leave the column safely as long as they do not land on it again. Inspired by Worms.',
    'paint-bomb-desc': 'Jet Set Radio! Paints <strong>9 squares</strong> (the chosen square and its 8 neighbors) for <strong>5 turns</strong>: nothing can be seen there, but play continues normally.',
    'paint-bomb-details': 'Pieces under paint remain playable but become invisible. Paint fades after 5 turns. Inspired by Jet Set Radio.',
    'pokeball-desc': 'Pokémon! Summons a <strong>random Pokémon</strong> (Pikachu or Jigglypuff for now) near your king with its usual movement.',
    'pokeball-details': 'The Pokémon appears on a free square near your king. More species may be added over time. Inspired by Pokémon.',
    'cardboard-desc': 'Metal Gear! <strong>Camouflages a piece for 5 turns</strong>: only you can see it; it becomes invisible to the opponent.',
    'cardboard-details': 'Choose any piece (ally or enemy). For 5 turns you see it normally; the opponent cannot see it on the board. Inspired by Metal Gear Solid.',
    'proximity-mine-desc': 'Perfect Dark! Places a <strong>mine invisible</strong> to the opponent: the first piece (ally or enemy) stepping on it explodes.',
    'proximity-mine-details': 'Place the mine on an empty square. Only the player who planted it can see it. It stays active until triggered or the game ends. Inspired by Perfect Dark.',
    'fake-crate-desc': 'Mario Kart! A <strong>fake crate</strong> sometimes replaces a real one (1 in 20 chance). The piece stepping on it is destroyed.',
    'fake-crate-details': 'Looks very similar to a real crate. The piece stepping on it is destroyed, then the fake crate is replaced by a real one. Inspired by Mario Kart.',
    'cherry-desc': 'Pac-Man! The cherry <strong>doubles the next item</strong> obtained: you receive two copies instead of one.',
    'cherry-details': 'Use the cherry and the next item found in a crate will be doubled (if you have room in your inventory). Inspired by Pac-Man.',
    'storm-wall-desc': 'Fortnite! Activates the <strong>Storm Wall</strong>: the board shrinks by one square per side per turn. Pieces outside the zone are lost.',
    'storm-wall-details': 'Can be used after 10 turns. The board progressively shrinks: any piece remaining in the storm zone is destroyed. Inspired by Fortnite.',
    'golden-gun-desc': 'GoldenEye 007! Shoots <strong>any piece</strong> and eliminates it instantly, even the king. Extremely rare.',
    'golden-gun-details': 'Click any piece on the board to destroy it. No protection (star, heart) resists the Golden Gun. The rarest item in the game. Inspired by GoldenEye 007.',
    ...
    'sackboy': 'Sackboy',
    'sackboy-desc': "Poupée de tissu créative de LittleBigPlanet. Personnalisable à l'infini, joyeux et collant (au sens craft). Votre imagination est son monde.",
    'deacon-st-john-desc': "Days Gone biker surviving Freakers and hunting for Sarah.",
    'deacon-st-john': "Deacon St. John",
    'chloe-frazer-desc': "Uncharted treasure hunter—Australian grit and her own agenda.",
    'chloe-frazer': "Chloe Frazer",
    'carmelita-fox-desc': "Interpol inspector in Sly Cooper—shock pistol, justice, and a soft spot for the thief.",
    'carmelita-fox': "Carmelita Fox",
    'trico-desc': "The Last Guardian’s winged beast—trust earned feather by feather.",
    'trico': "Trico",
    'abby-desc': "The Last of Us Part II warrior—raw strength, revenge, ambiguous redemption.",
    'abby': "Abby",
    'joel-desc': "The Last of Us smuggler—lost fatherhood, Ellie, impossible choices.",
    'joel': "Joel",
    'jin-sakai-desc': "Ghost of Tsushima samurai turned Ghost—honor broken to save the island.",
    'jin-sakai': "Jin Sakai",
    'kratos': "Kratos",
    'toro-inoue-desc': "White cat mascot of Doko Demo Issyo—Sony’s gentle Japanese ambassador.",
    'toro-inoue': "Toro Inoue",
    'sly-cooper-desc': "Gentleman raccoon thief—cane, stealth, and family legacy.",
    'sly-cooper': "Sly Cooper",
    'sir-daniel-fortesque-desc': "MediEvil’s skeletal knight—unlikely hero with dark humor.",
    'sir-daniel-fortesque': "Sir Daniel Fortesque",
    'ratchet-desc': "Lombax hero of Ratchet & Clank—wild weapons and galaxy-saving antics.",
    'ratchet': "Ratchet",
    'cole-macgrath-desc': "inFAMOUS conduit—karma, lightning, and Empire City.",
    'cole-macgrath': "Cole MacGrath",
    'william-adams-desc': "Western samurai of Nioh—yokai, ki, and deadly blades.",
    'william-adams': "William Adams",
    'pilote-gran-turismo-desc': "Anonymous Gran Turismo driver—perfect lines and real driving passion.",
    'pilote-gran-turismo': "Gran Turismo Driver",
    'ellie-desc': "The Last of Us heroine—immune, determined, broken and unbreakable.",
    'ellie': "Ellie",
    'atreus-desc': "Kratos’s son in God of War—archer, ancient tongues, divine destiny.",
    'atreus': "Atreus",
    'nathan-drake': "Nathan Drake",
    'clank-desc': "Zoni robot and brains of Ratchet & Clank—small, brilliant, essential.",
    'clank': "Clank",
    'jak': 'Jak',
    'jak-desc': "Héros d'Haven City dans Jak and Daxter. Éco, Dark, Light : l'énergie le transforme autant que l'aventure. Silence d'origine, puissance acquise. Éco sombre : après un déplacement, peut marquer une case voisine (interdit aux ennemis 1 tour).",
    'daxter': 'Daxter',
    ...
    'steeve-desc': "Compagnon Core de Far Eden aux côtés de Joule Adams. Carcasse métallique, cœur fidèle, prêt pour le désert. Sans lui, la traversée serait solitaire.",
    'cooper': 'Cooper',
    'cooper-desc': "Hero of Grabbed by the Ghoulies, a Rareware game released on Xbox. In the haunted Ghoulies mansion: British humour and arcade brawling. A Rare classic too often forgotten.",
    'hornet': 'Hornet',
    'hornet-desc': "Agent d'élite plongé dans les fractures temporelles de Quantum Break. Missions tendues, réalités qui se fissurent, sang-froid obligatoire. Chaque seconde peut tout changer.",
    'shu': 'Shu',
    'shu-desc': "Survivant miniature de Grounded. Dans le jardin géant, une fourmi est un boss. Courage à l'échelle d'un brin d'herbe.",
    ...
    'lupus-desc': "Survivant de State of Decay, monde zombie sans filet. Base, communauté, choix durs. L'espoir se gère comme des ressources.",
    'moine': 'Monk',
    'moine-desc': "Age of Empires monk, the cult unit that converts foes with a cry of \"Wololo!\". Faith, patience and a touch of magic: he turns enemy troops without drawing a sword. Conversion: 100% vs pawn, 75% vs knight, 50% vs rook, 25% vs queen; 0% vs unique or king.",
    'vela': 'Vela',
    'vela-desc': "Exploratrice Xbox au nom d'étoile, toujours tournée vers l'horizon. Curieuse, déterminée, lumière dans l'inconnu. Sa route s'écrit à chaque pas.",
    'nathan-drake-desc': "Chasseur de trésors charismatique d'Uncharted. Quips, escalade et malchance spectaculaire : Indiana Jones version PlayStation. Fortune et gloire… surtout des bleus.",
    'kratos-desc': "Ancien dieu de la guerre spartiate, désormais père en Midgard. Lames du Chaos, hache Léviathan et rage contenue. Un seul mot à son fils suffit parfois.",
    ...
    'master-chief-desc': "Spartan-117, légende silencieuse de Halo. Armure MJOLNIR, Cortana à l'oreille, Flood et Covenant en ligne de mire. Il termine toujours le combat. Bouclier d'énergie : secondaire qui ignore une capture une seule fois.",
    'pikachu-desc': "Pokémon Électrique emblématique, partenaire loyal de Sacha. Joues pétillantes, éclair foudroyant et cri mythique. La souris jaune qui a électrisé le monde. Éclair : frappe toutes les pièces adverses adjacentes situées sur des cases blanches, sans se déplacer (recharge 2 tours).",
    'moine-ability': "Conversion (Wololo): 100% pawn, 75% knight, 50% rook, 25% queen; 0% unique or king.",
    'link-ability': "Bouclier d'Hyrule : 20 % de chance de bloquer une attaque. Secondaire Flèche héroïque : tire en ortho à distance 3 sans se déplacer (1 fois / 3 tours).",
    'bowser-ability': "Koopalings : invoque l'un des 7 Koopalings (déplacement de pion) sur une case voisine ; 1 invocation par Koopaling (7 max), consomme le tour.",
    'kirby-ability': "Aspiration : se déplace comme la dernière pièce ennemie capturée (départ : mouvement de cavalier).",
    'bayonetta-ability': "Witch Time : après une capture, le prochain coup adverse adjacent est ralenti — cette pièce peut immédiatement se replacer d'1 case.",
    ...
    'tails-ability': "Vol de soutien : transporte une pièce alliée adjacente d'1 case vers l'avant.",
    'dr-robotnik-ability': "Robot Capsule : secondaire qui place un petit robot pion neutre sur une case vide voisine (bloque 1 tour).",
    'viva-pinata-ability': "Confetti burst: when captured, grants 3 random different items to the player who owned it.",
    'ecco-dolphin-ability': "Nage libre : se déplace comme une tour et peut traverser une pièce pour capturer la suivante sur la même ligne ou colonne.",
    'ulala-ability': "Groove laser : secondaire qui contrôle temporairement une pièce ennemie adjacente pendant 1 tour.",
    'master-chief-ability': "Bouclier d'énergie : secondaire qui ignore une capture une seule fois.",
    'joanna-dark-ability': "Camouflage RCP-120 : avance de 4 cases en ligne droite (ortho uniquement). Double-clic avant de bouger pour devenir invisible 1 tour (semi-visible pour vous, invisible aux adversaires ; toujours capturable sur sa case).",
  ...
  es: {
    ...
    'cg-blurb-short': 'Una iniciativa de <a class="cg-logo-link" href="https://www.culture-games.com" target="_blank" rel="noopener noreferrer"><img class="cg-logo" src="/images/site/logo-header-culture-games-v5.svg" alt="Culture Games" /></a> para dar a conocer las mascotas del videojuego — y aprender divirtiéndose.',
    'cg-blurb-more': 'La lista de piezas ofrece enlaces a fichas para profundizar en cada personaje. Un minijuego pensado para promover la cultura del videojuego mientras te diviertes.',
    'cg-see-more': 'Ver más',
    'cg-see-less': 'Ver menos',
    ...
    'about-creator-nav': 'El creador',
    'about-creator-title': '¿Quién soy?',
    'about-creator-p1': 'Fan de videojuegos desde principios de los 90, activo en la comunidad de Super Smash Bros. y creador de ssb-experience.com y culture-games.com.',
    'about-creator-p2': 'También aficionado al ajedrez, con buenos recuerdos del juego de mesa Tempête sur l’échiquier.',
    'about-creator-p3': 'Video Games Battle reúne todas estas pasiones: un juego hecho por un fan, para los fans.',
    ...
    'objection-name': 'Objection',
    'sonic-shoes-name': 'Zapatillas de Sonic',
    'turret-name': 'Torreta',
    'paint-bomb-name': 'Bomba de pintura',
    'pokeball-name': 'Pokéball',
    'cardboard-name': 'Cartón',
    'proximity-mine-name': 'Mina de proximidad',
    'fake-crate-name': 'Caja falsa',
    'cherry-name': 'Cereza',
    'storm-wall-name': 'Muro de la Tormenta',
    'golden-gun-name': 'Golden Gun',
    'crowbar-name': 'Palanca',
    'mana-potion-name': 'Poción de maná',
    ...
    'phoenix-no-piece': 'Ninguna pieza perdida para resucitar.',
    ...
    'objection-desc': '¡Ace Attorney! <strong>Anula el movimiento anterior</strong> y lo prohíbe en el turno siguiente.',
    'objection-details': 'Deshace el último desplazamiento (y una captura simple si la hubo). El adversario no puede repetir exactamente ese movimiento en su siguiente turno. Consume tu turno. Inspirado en Ace Attorney.',
    'sonic-shoes-desc': '¡Velocidad Sonic! Permite a un <strong>peón, caballo o alfil</strong> jugar <strong>dos movimientos</strong> en el mismo turno.',
    'sonic-shoes-details': 'Activa las zapatillas, luego mueve dos veces la misma pieza (solo peón, caballo o alfil). Inspirado en Sonic the Hedgehog.',
    'turret-desc': '¡Worms! Elige una <strong>columna</strong>: cualquier pieza enemiga que se pose en ella es destruida. La torreta desaparece tras una captura.',
    'turret-details': 'Toda la columna está marcada. Cualquier pieza enemiga que se pose en una de esas casillas desaparece, venga de donde venga — incluso un peón que ya avance dentro de la columna. Las piezas enemigas pueden salir de la columna sin daño mientras no vuelvan a posarse en ella. Inspirado en Worms.',
    'paint-bomb-desc': '¡Jet Set Radio! Pinta <strong>9 casillas</strong> (la elegida y las 8 adyacentes) durante <strong>5 turnos</strong>: no se ve nada, pero el juego continúa con normalidad.',
    'paint-bomb-details': 'Las piezas bajo pintura siguen siendo jugables pero se vuelven invisibles. La pintura desaparece tras 5 turnos. Inspirado en Jet Set Radio.',
    'pokeball-desc': '¡Pokémon! Invoca un <strong>Pokémon al azar</strong> (Pikachu o Rondoudou por ahora) cerca de tu rey, con su movimiento habitual.',
    'pokeball-details': 'El Pokémon aparece en una casilla libre cerca de tu rey. Inspirado en Pokémon.',
    'cardboard-desc': '¡Metal Gear! <strong>Camufla una pieza durante 5 turnos</strong>: solo tú la ves; se vuelve invisible para el adversario.',
    'cardboard-details': 'Elige cualquier pieza. Durante 5 turnos la ves con normalidad; el adversario no la ve en el tablero. Inspirado en Metal Gear Solid.',
    'proximity-mine-desc': '¡Perfect Dark! Coloca una <strong>mina invisible</strong> para el adversario: la primera pieza (aliada o enemiga) que pise explota.',
    'proximity-mine-details': 'Coloca la mina en una casilla vacía. Solo el jugador que la plantó la ve. Permanece activa hasta explotar o fin de partida. Inspirado en Perfect Dark.',
    'fake-crate-desc': '¡Mario Kart! Una <strong>caja falsa</strong> a veces reemplaza una real (1 de cada 20). La pieza que pise encima es destruida.',
    'fake-crate-details': 'Se parece mucho a una caja real. La pieza que pise encima es destruida, luego la caja falsa es reemplazada por una real. Inspirado en Mario Kart.',
    'cherry-desc': '¡Pac-Man! La cereza <strong>duplica el próximo objeto</strong> obtenido: recibes dos copias en lugar de una.',
    'cherry-details': 'Usa la cereza y el próximo objeto encontrado en una caja se duplicará (si tienes espacio en tu inventario). Inspirado en Pac-Man.',
    'storm-wall-desc': '¡Fortnite! Activa el <strong>Muro de la Tormenta</strong>: el tablero se reduce una casilla por lado por turno. Las piezas fuera de la zona se pierden.',
    'storm-wall-details': 'Utilizable después de 10 turnos. El tablero disminuye progresivamente: toda pieza que permanezca en la zona de tormenta es destruida. Inspirado en Fortnite.',
    'golden-gun-desc': '¡GoldenEye 007! Dispara a <strong>cualquier pieza</strong> y la elimina instantáneamente, incluso al rey. Extremadamente raro.',
    'golden-gun-details': 'Haz clic en cualquier pieza del tablero para destruirla. Ninguna protección (estrella, corazón) resiste al Golden Gun. El objeto más raro del juego. Inspirado en GoldenEye 007.',
  ...
  de: {
    ...
    'about-creator-nav': 'Der Schöpfer',
    'about-creator-title': 'Wer bin ich?',
    'about-creator-p1': 'Videospiel-Fan seit Anfang der 90er, aktiv in der Super-Smash-Bros.-Community und Schöpfer von ssb-experience.com und culture-games.com.',
    'about-creator-p2': 'Auch Schach-Amateur, mit schönen Erinnerungen an das Brettspiel Tempête sur l’échiquier.',
    'about-creator-p3': 'Video Games Battle vereint all diese Leidenschaften: ein Spiel von einem Fan, für Fans.',
  ...
  pt: {
    ...
    'about-creator-nav': 'O criador',
    'about-creator-title': 'Quem sou eu?',
    'about-creator-p1': 'Fã de videojogos desde o início dos anos 90, ativo na comunidade Super Smash Bros. e criador de ssb-experience.com e culture-games.com.',
    'about-creator-p2': 'Também amador de xadrez, com boas memórias do jogo de tabuleiro Tempête sur l’échiquier.',
    'about-creator-p3': 'Video Games Battle reúne todos estes interesses: um jogo feito por um fã, para fãs.',
  ...
  it: {
    ...
    'about-creator-nav': 'Il creatore',
    'about-creator-title': 'Chi sono?',
    'about-creator-p1': 'Fan di videogiochi dall’inizio degli anni ’90, attivo nella community di Super Smash Bros. e creatore di ssb-experience.com e culture-games.com.',
    'about-creator-p2': 'Anche appassionato dilettante di scacchi, con bei ricordi del gioco da tavolo Tempête sur l’échiquier.',
    'about-creator-p3': 'Video Games Battle riunisce tutti questi interessi: un gioco fatto da un fan, per i fan.',
